...
import { css as a, addClass as c, removeElement as u, removeClass as d } from "fourdom";
function f(r, e, t) {
...
var o = /* @__PURE__ */ ((r) => (r.wrapperSelectorId = "trickling", r.customParentClassName = "trickling-custom-parent", r.busyFlagClassName = "trickling-busy", r.template = `
  ...
  </div>`, r.barSelector = '[role="bar"]', r.spinnerSelector = '[role="spinner"]', r.rtlClassName = "rtl", r))(o || {}), m = /* @__PURE__ */ ((r) => (r.queryBarElementError = "[Trickling]: Can not find 'barSelector' element!", r.queryAppendToElementError = "[Trickling]: Can not find 'options.appendTo' element!", r))(m || {});
const l = class {
  constructor(e) {
  ...
  set(e) {
    ...
    return this.triggerRepaint(), b((g) => {
      this.positionUsing === "" && (this.positionUsing = this.getPositioningCSS()), a(n, this.barPositionCSS(e, i, v)), e === 1 ? (a(s, {
        transition: "none",
        opacity: 1
  ...
  visible() {
    if (this.isRendered() && !this.options.removeFromDOMWhenDone) {
      const e = this.getWrapperElement();
      e && a(e, { display: "block", opacity: 1 }), this.setPercent(null);
    }
  }
  hidden() {
    const e = this.getWrapperElement();
    e && (a(e, { display: "none" }), this.setPercent(null), this.translateProgressBar(this.getBarElement(e), !0));
  }
  remove(e) {
